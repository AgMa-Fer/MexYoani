...
final List<MapEntry<String, LatLng>> line1Stations = [
...
// Lista de estaciones de la Línea 2
final List<MapEntry<String, LatLng>> line2Stations = [
...
final List<MapEntry<String, LatLng>> line3Stations = [
...
final List<MapEntry<String, LatLng>> line4Stations = [
...
final List<MapEntry<String, LatLng>> line5Stations = [
...
final List<MapEntry<String, LatLng>> line6Stations = [
...
final List<MapEntry<String, LatLng>> line7Stations = [
...
final List<MapEntry<String, LatLng>> line8Stations = [
  MapEntry(
...
final List<MapEntry<String, LatLng>> line9Stations = [
  MapEntry("Pantitlán", LatLng(19.415351498671384, -99.07437711948525)),
...
final List<MapEntry<String, LatLng>> lineAStations = [
...
final List<MapEntry<String, LatLng>> lineBStations = [
...
final List<MapEntry<String, LatLng>> line12Stations = [
