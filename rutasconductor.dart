...
import 'package:prueba/src/mainconductor.dart';
...
class RutasConductor extends StatefulWidget {
  @override
  _MapScreenState createState() => _MapScreenState();
}

class _MapScreenState extends State<RutasConductor> {
            ...
            children: <Widget>[
              DrawerHeader(
                decoration: BoxDecoration(
                  color: Colors.indigo[700], // Color del encabezado
                ),
                child: Column(
                  crossAxisAlignment:
